...
The user can:
- Move their spaceship using the arrow keys 
- Shoot laser beams using spacebar 
- Destroy enemy spaceships 

## :satellite: Technology Used: 
- C#
- Unity 
- Visual Studio

## :high_brightness: Future Features:
- Global high score 
- Additional waves with new enemies 
